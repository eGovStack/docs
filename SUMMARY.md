...
* [Products & Modules](product/modules/README.md)
  ...
  * [Property Tax](product/modules/property-tax/README.md)
    ...
    * [Property Tax Service](product/modules/property-tax/property-tax-service/README.md)
      ...
      * [PT Update Number & Alternate Number](product/modules/property-tax/property-tax-service/pt-update-number-and-alternate-number/README.md)
        * [Update Primary Mobile Number & Alternate Mobile Number](product/modules/property-tax/property-tax-service/pt-update-number-and-alternate-number/update-primary-mobile-number-and-alternate-mobile-number.md)
    ...
    * [PT - Create Property UI Details](product/modules/property-tax/pt-create-property-ui-details/README.md)
      ...
      * [Employee Inbox (Old UI)](product/modules/property-tax/pt-create-property-ui-details/employee-inbox-old-ui.md)
  ...
  * [Water & Sewerage (W\&S)](product/modules/water-and-sewerage/README.md)
    ...
    * [W\&S User Manual](product/modules/water-and-sewerage/w-and-s-user-manual/README.md)
      ...
      * [W\&S Employee User Manual](product/modules/water-and-sewerage/w-and-s-user-manual/w-and-s-employee-user-manual.md)
  ...
  * [Online Building Plan Approval System (OBPAS)](product/modules/online-building-plan-approval-system-obpas/README.md)
    ...
    * [OBPAS DIGIT UI](product/modules/online-building-plan-approval-system-obpas/obpas-digit-ui/README.md)
      * [Stakeholder - Registration Flow](product/modules/online-building-plan-approval-system-obpas/obpas-digit-ui/stakeholder-registration-flow.md)
      * [OBPS-BPA/OC-BPA Employee Flow](product/modules/online-building-plan-approval-system-obpas/obpas-digit-ui/obps-bpa-oc-bpa-employee-flow/README.md)
        * [OBPS Inbox](product/modules/online-building-plan-approval-system-obpas/obpas-digit-ui/obps-bpa-oc-bpa-employee-flow/obps-inbox.md)
        * [OBPS Search Application](product/modules/online-building-plan-approval-system-obpas/obpas-digit-ui/obps-bpa-oc-bpa-employee-flow/obps-search-application.md)
      * [OBPS-BPA/OC-BPA Architect](product/modules/online-building-plan-approval-system-obpas/obpas-digit-ui/obps-bpa-oc-bpa-architect.md)
      * [OBPS EDCR /OC-EDCR](product/modules/online-building-plan-approval-system-obpas/obpas-digit-ui/obps-edcr-oc-edcr.md)
      * [OBPS BPA / OCBPA Citizen](product/modules/online-building-plan-approval-system-obpas/obpas-digit-ui/obps-bpa-ocbpa-citizen.md)
      * [Employee - Stakeholder](product/modules/online-building-plan-approval-system-obpas/obpas-digit-ui/employee-stakeholder/README.md)
        * [Stakeholder Inbox](product/modules/online-building-plan-approval-system-obpas/obpas-digit-ui/employee-stakeholder/stakeholder-inbox.md)
        * [Stakeholder Search Application](product/modules/online-building-plan-approval-system-obpas/obpas-digit-ui/employee-stakeholder/stakeholder-search-application.md)
    * [OBPAS Service Configuration](product/modules/online-building-plan-approval-system-obpas/obpas-service-configuration/README.md)
      ...
      * [Setting Up eDCR Service](product/modules/online-building-plan-approval-system-obpas/obpas-service-configuration/setting-up-edcr-service.md)
  ...
  * [Finance](product/modules/finance/README.md)
    ...
    * [Finance Service Configuration](product/modules/finance/setting-up-finance-service/README.md)
      * [Finance Collections Voucher Consumer Service](product/modules/finance/setting-up-finance-service/finance-collections-voucher-consumer-service.md)
  ...
  * [Fire NOC](product/modules/fire-noc/README.md)
    ...
    * [NOC DIGIT UI](product/modules/fire-noc/noc-digit-ui/README.md)
      * [NOC Inbox](product/modules/fire-noc/noc-digit-ui/noc-inbox.md)
      * [Application Overview](product/modules/fire-noc/noc-digit-ui/application-overview.md)
  ...
  * [HRMS](product/modules/hrms/README.md)
    ...
    * [HRMS Service](product/modules/hrms/hrms-service.md)
    * [Employees Count UI Flow](product/modules/hrms/employees-count-ui-flow.md)
  * [Events And Notifications](product/modules/events-and-notifications/README.md)
    * [Citizen Flow](product/modules/events-and-notifications/citizen-flow.md)
    * [Employee Flow - Events](product/modules/events-and-notifications/employee-flow-events.md)
    * [Employee Flow - Messages](product/modules/events-and-notifications/employee-flow-messages.md)
  * [Citizen Engagement Module](product/modules/citizen-engagement-module/README.md)
    * [Documents: Implementation Details](product/modules/citizen-engagement-module/documents-implementation-details.md)
...
* [Full Installation](setup/install-on-cloud/README.md)
  * [On AWS](setup/install-on-cloud/on-aws.md)
    ...
    * [5. Prepare Deployment Config](setup/install-on-cloud/on-aws/4.-post-deployment.md)
    ...
    * [FAQ](setup/install-on-cloud/on-aws/faq.md)
  * [On Azure](setup/install-on-cloud/on-azure.md)
    * [1. Pre-requisites](setup/install-on-cloud/on-azure/1.-pre-requisites.md)
    * [2. Understanding AKS](setup/install-on-cloud/on-azure/2.-understanding-aks.md)
    * [3. Infra-as-code (Terraform)](setup/install-on-cloud/on-azure/3.-infra-as-code-terraform.md)
...
* [Configure DIGIT](configuration/configure-digit/README.md)
  ...
  * [Configuring Services](configuration/configure-digit/configuring-digit-services/README.md)
    ...
    * [FileStore Service](configuration/configure-digit/configuring-digit-services/filestore-service.md)
    * [Telemetry Service](configuration/configure-digit/configuring-digit-services/telemetry-service.md)
    * [Report Service](configuration/configure-digit/configuring-digit-services/report-service.md)
    * [ID Generation Service](configuration/configure-digit/configuring-digit-services/id-generation-service.md)
    * [Localization Service](configuration/configure-digit/configuring-digit-services/localization-service.md)
    * [Email Notification Service](configuration/configure-digit/configuring-digit-services/email-notification-service.md)
    * [SMS Notification Service](configuration/configure-digit/configuring-digit-services/sms-notification-service.md)
    * [SMS Template Approval Process](configuration/configure-digit/configuring-digit-services/sms-template-approval-process.md)
    * [Searcher Service](configuration/configure-digit/configuring-digit-services/searcher-service.md)
    * [Zuul Service](configuration/configure-digit/configuring-digit-services/zuul-service.md)
    * [User OTP Service](configuration/configure-digit/configuring-digit-services/user-otp-service.md)
    * [eGov OTP Service](configuration/configure-digit/configuring-digit-services/egov-otp-service.md)
    * [Persister Service](configuration/configure-digit/configuring-digit-services/persister-service.md)
    * [Encryption Service](configuration/configure-digit/configuring-digit-services/encryption-service.md)
    * [Document Uploader Service](configuration/configure-digit/configuring-digit-services/document-uploader-service.md)
    * [Notification Enhancement Based on Different Channels](configuration/configure-digit/configuring-digit-services/notification-enhancement-based-on-different-channels.md)
  ...
  * [QA Automation](configuration/configure-digit/qa-automation/README.md)
    ...
    * [Automation Framework Knowledge Base](configuration/configure-digit/qa-automation/automation-framework-knowledge-base/README.md)
      * [Automation Test Tags](configuration/configure-digit/qa-automation/automation-framework-knowledge-base/automation-test-tags.md)
      * [Automation Test Reporting](configuration/configure-digit/qa-automation/automation-framework-knowledge-base/automation-test-reporting.md)
    * [State-Level UI Customization](configuration/configure-digit/qa-automation/state-level-ui-customization.md)
