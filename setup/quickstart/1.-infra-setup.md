...
## **Setting up a Kubernetes cluster on a Local machine/Single VM**
...
<summary>In your local machine/VM</summary>
...
<summary>Setup on a Cloud (AWS)</summary>
...
4. The following [main.tf ](https://github.com/egovernments/DIGIT-DevOps/blob/quickstart/infra-as-code/terraform/digit-quickstart-aws/main.tf)will create ec2 instance.
...
5\.  Update [variables.tf](https://github.com/egovernments/DIGIT-DevOps/blob/quickstart/infra-as-code/terraform/digit-quickstart-aws/variables.tf)
...
```
cd DIGIT-DevOps/infra-as-code/terraform/digit-quickstart-vm
```
