...
While you want to destroy the setup after you have explored/experienced the DIGIT quickstart you can teardown the entire setup using the following instructions
