...
1. DIGIT uses [golang](https://golang.org/doc/install#download) (required v1.13.3) scripts to simplify the deployment process an automated scripts to deploy the services on to Kubernete.
