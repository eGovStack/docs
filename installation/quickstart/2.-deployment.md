...
* [DIGIT deployment on k3d](2.-deployment.md#digit-deployment-on-k3d)
* [Pre-requisites for deployment](2.-deployment.md#1.-pre-requisites)
* [Deployment configurations](2.-deployment.md#2.-prepare-deployment-configs)
* [Deployment](2.-deployment.md#3.-deployment)
* [Post-deployment steps ](2.-deployment.md#4.-post-deployment-steps)
* [Destroy setup](2.-deployment.md#5.-destroying-the-setup)
