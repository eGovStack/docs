...
‌ _**Name of the service? test-service**_\
_**Application Type? NA**_\
_**Kubernetes health checks to be enabled? Yes**_\
_**Flyway DB migration container necessary? No**_\
_**Expose service to the internet? Yes**_\
_**Route through API gateway \[zuul] No**_\
_**Context path? hello**_‌
