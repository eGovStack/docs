...
#### The data config file contains the following aspects <a href="#the-data-config-file-contains-the-following-aspects" id="the-data-config-file-contains-the-following-aspects"></a>
